...
@doc replace(ParallelKernel.RANDN_DOC,               "@init_parallel_kernel" => "@init_parallel_stencil") macro randn(args...)             check_initialized(__module__); esc(:(ParallelStencil.ParallelKernel.@randn($(args...)))); end
